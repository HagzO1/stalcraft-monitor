...
version = 1.0.0
requirements = python3,kivy==2.3.1,kivy-garden.matplotlib,stalcraft-api>=2.1.0,aiogram>=3.0.0,Pillow>=10.0.0,aiofiles>=23.0.0,aiohttp==3.9.5,matplotlib>=3.5.0,numpy,pydantic,pydantic-core
